...
public class DataAccessManager {	
	...
	private String filePath="src/dataAccess/";
	...
	public  DataAccessManager(String jdbcDriver,String dbUrl,String dbUser,String dbPassword) {
	...
	public File openExcelFile(){
		if (excelFile==null){
			try{			
				excelFile = new File(filePath+"stuInfo.xls");
	...
	public File openXMLFile(){
		if (xmlFile==null){
			try{			
				xmlFile = new File(filePath+"stuInfo.xml");
